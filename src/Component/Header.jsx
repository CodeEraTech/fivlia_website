...
const Header = () => {
  ...
  const activePages = pages.filter(
    (p) => p.status && p.pageSlug && p.pageTitle
  );
  ...
  useEffect(() => {
    ...
    debounceTimeout.current = setTimeout(() => {
      get(
        `${ENDPOINTS.SEARCH_PRODUCTS}&name=${encodeURIComponent(searchQuery)}`
      )
        .then((res) => {
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div
          className="d-flex align-items-center header-search-mobile py-2"
          style={{ borderBottom: "1px solid #eee" }}
        >
          <div
            className="flex-grow-1"
            ref={searchWrapperRef}
            style={{ position: "relative", maxWidth: "calc(100% - 120px)" }}
          >
            ...
            <input
              ...
              style={{
                ...
                borderRadius: 12,
                fontSize: "1rem",
                boxShadow: "0 2px 8px rgba(48,87,78,0.06)",
              }}
          ...
          {/* Mobile icons row */}
          <div
            className="d-flex align-items-center gap-3 header-icons-mobile flex-shrink-0 ms-3"
            style={{ minWidth: 100, justifyContent: "flex-end" }}
          >
            <div className="list-inline-item d-inline-block">
              {!isLoggedIn ? (
                <a
      ...
      <nav className="navbar navbar-expand-lg navbar-light sticky-top">
        <div className="container d-flex align-items-center w-100">
          ...
          <div
            className="header-search-desktop ms-3 me-4"
            ref={searchWrapperRef}
            style={{
              display: "none",
              flex: 1,
            ...
            <ul className="navbar-nav navbar-light">
              <li className="nav-item dmenu dropdown">
                ...
                >
                  ...
                  {catError && (
                    <div className="dropdown-item text-danger">{catError}</div>
                  )}
